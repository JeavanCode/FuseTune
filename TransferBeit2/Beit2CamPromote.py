...
class Ensemble(nn.Module):
    def __init__(self, embed_dim, num_blocks, num_heads, mlp_ratio, num_classes):
        ...
        self.model.load_state_dict(torch.load(r'..\ckpt\beitv2_base_patch16_224_pt1k_300e.pth')['model'], strict=False)
...
parser.add_argument('--EXP_NUM', default='{Beit2-Cam-Promote}', type=str)
