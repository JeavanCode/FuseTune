...
class Ensemble(nn.Module):
    def __init__(self, embed_dim, num_blocks, num_heads, mlp_ratio, num_classes):
        ...
        # self.beta = args.beta
        # self.ema = get_model('beitv2_beit-base-p16_8xb256-amp-coslr-300e_in1k', pretrained=True).backbone
    ...
    def forward_ema(self, x):
        with torch.no_grad():
            x = self.ema(x, mask=None)[0]
            return self.classifierEma(x)


parser = argparse.ArgumentParser()
parser.add_argument('--EXP_NUM', default='{Beit2-Clevr-Finetune}', type=str)
...
if __name__ == '__main__':
    ...
    # model = torch.load(r'D:\Pycharm\Projects\PRCV2023\Ensemble\CheckPoints\{Beit2-1%Finetune}.pth')
